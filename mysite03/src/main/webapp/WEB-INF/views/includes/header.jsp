...
<div id="header">
	<h1>${title}</h1>
		<div id="languages">
			<c:choose>
				<c:when test="${lang == 'en'}">
					<a href="locale/switch?lang=ko" data-lang="ko">KO</a><a href="" class="active" data-lang="en">EN</a>
				</c:when>
				<c:otherwise>
					<a href="" data-lang="ko" class="active">KO</a><a href="locale/switch?lang=en" data-lang="en">EN</a>
				</c:otherwise>
			</c:choose>
		</div>
	<ul>
